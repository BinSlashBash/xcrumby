...
public class DoubleMetaphone implements StringEncoder {
    ...
    static {
        ...
        L_R_N_M_B_H_F_V_W_SPACE = new String[]{"L", "R", "N", "M", "B", "H", "F", "V", "W", MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR};
    ...
    public String doubleMetaphone(String value, boolean alternate) {
        ...
        while (!result.isComplete() && index <= value.length() - 1) {
            switch (value.charAt(index)) {
                case C0065R.styleable.TwoWayView_android_textDirection /*65*/:
                case 'E':
                case 'I':
                case 'O':
                case 'U':
                ...
                case C0065R.styleable.TwoWayView_android_layoutDirection /*66*/:
                    ...
                    break;
                case C0065R.styleable.TwoWayView_android_paddingStart /*67*/:
                    index = handleC(value, result, index);
                    break;
                case C0065R.styleable.TwoWayView_android_paddingEnd /*68*/:
