...
public class Rule {
    ...
    static class C12151 implements RPattern {
        C12151() {
        }
    ...
    static class C12162 extends Rule {
        private final String loc;
        private final int myLine;
        final /* synthetic */ int val$cLine;
        final /* synthetic */ String val$location;

        C12162(String x0, String x1, String x2, PhonemeExpr x3, int i, String str) {
            this.val$cLine = i;
    ...
    static class C12173 implements RPattern {
        C12173() {
        }
    ...
    static class C12184 implements RPattern {
    ...
    static class C12195 implements RPattern {
        final /* synthetic */ String val$content;
    ...
    static class C12206 implements RPattern {
        final /* synthetic */ String val$content;
    ...
    static class C12228 implements RPattern {
        final /* synthetic */ String val$bContent;
        final /* synthetic */ boolean val$shouldMatch;

        C12228(String str, boolean z) {
            this.val$bContent = str;
            this.val$shouldMatch = z;
        }
    ...
    static class C12239 implements RPattern {
        final /* synthetic */ String val$bContent;
        final /* synthetic */ boolean val$shouldMatch;

        C12239(String str, boolean z) {
            this.val$bContent = str;
            this.val$shouldMatch = z;
        }
    ...
    public static final class Phoneme implements PhonemeExpr {
        ...
        static class C06831 implements Comparator<Phoneme> {
            C06831() {
            }
    ...
    static {
        ALL_STRINGS_RMATCHER = new C12151();
    ...
    private static PhonemeExpr parsePhonemeExpr(String ph) {
        ...
        if (ph.endsWith(")")) {
            ...
            if (body.startsWith("|") || body.endsWith("|")) {
                phs.add(new Phoneme(UnsupportedUrlFragment.DISPLAY_NAME, Languages.ANY_LANGUAGE));
            }
        ...
        while (scanner.hasNextLine()) {
            ...
            if (inMultilineComment) {
                ...
                if (line.length() == 0) {
                    ...
                    try {
                        Rule r = new C12162(stripQuotes(parts[0]), stripQuotes(parts[1]), stripQuotes(parts[2]), parsePhonemeExpr(stripQuotes(parts[3])), currentLine, location);
    ...
    private static RPattern pattern(String regex) {
        ...
        if (content.contains("[")) {
            ...
            if (startsWithBox && endsWithBox) {
                ...
                if (!boxContent.contains("[")) {
                    ...
                    if (startsWith && endsWith) {
                        return new C12217(bContent, shouldMatch);
                    }
                    if (startsWith) {
                        return new C12228(bContent, shouldMatch);
                    }
                    if (endsWith) {
                        return new C12239(bContent, shouldMatch);
                    }
                }
            }
            ...
            return new C12184(content);
        } else if ((startsWith || endsWith) && content.length() == 0) {
            return ALL_STRINGS_RMATCHER;
        } else {
            if (startsWith) {
                return new C12195(content);
            }
            if (endsWith) {
                return new C12206(content);
            }
        }
