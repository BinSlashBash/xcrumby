...
public class ChangeLogListView extends ListView implements OnItemClickListener {
    ...
    protected class ParseAsyncTask extends AsyncTask<Void, Void, ChangeLog> {
        ...
        protected ChangeLog doInBackground(Void... params) {
            try {
                ...
                Log.e(ChangeLogListView.TAG, ChangeLogListView.this.getResources().getString(C0659R.string.changelog_internal_error_parsing), e);
            }
            return null;
        }
        ...
        protected void onPostExecute(ChangeLog chg) {
            if (chg != null) {
                if (VERSION.SDK_INT >= 11) {
                    ...
                    while (i$.hasNext()) {
                        this.mAdapter.add((ChangeLogRow) i$.next());
                    }
                }
    ...
    protected void initAttrs(AttributeSet attrs, int defStyle) {
        TypedArray a = getContext().getTheme().obtainStyledAttributes(attrs, C0659R.styleable.ChangeLogListView, defStyle, defStyle);
        try {
            this.mRowLayoutId = a.getResourceId(0, this.mRowLayoutId);
            this.mRowHeaderLayoutId = a.getResourceId(1, this.mRowHeaderLayoutId);
            this.mChangeLogFileResourceId = a.getResourceId(2, this.mChangeLogFileResourceId);
            this.mChangeLogFileResourceUrl = a.getString(3);
        } finally {
            a.recycle();
        }
    }
        ...
        try {
            ...
            if (chg != null) {
                ...
                if (this.mChangeLogFileResourceUrl == null || (this.mChangeLogFileResourceUrl != null && Util.isConnected(getContext()))) {
                    ...
                    Toast.makeText(getContext(), C0659R.string.changelog_internal_error_internet_connection, 1).show();
                }
            ...
            Log.e(TAG, getResources().getString(C0659R.string.changelog_internal_error_parsing), e);
        }
    }
