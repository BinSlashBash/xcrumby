...
class SearchViewCompatHoneycomb {
    ...
    static class C00461 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00461(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00472 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00472(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
