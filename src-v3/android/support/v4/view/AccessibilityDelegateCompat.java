...
public class AccessibilityDelegateCompat {
    ...
    static class AccessibilityDelegateIcsImpl extends AccessibilityDelegateStubImpl {
        ...
        class C07221 implements AccessibilityDelegateBridge {
            final /* synthetic */ AccessibilityDelegateCompat val$compat;

            C07221(AccessibilityDelegateCompat accessibilityDelegateCompat) {
        ...
        public Object newAccessiblityDelegateBridge(AccessibilityDelegateCompat compat) {
            return AccessibilityDelegateCompatIcs.newAccessibilityDelegateBridge(new C07221(compat));
        }
    ...
    static class AccessibilityDelegateJellyBeanImpl extends AccessibilityDelegateIcsImpl {
        ...
        class C07231 implements AccessibilityDelegateBridgeJellyBean {
            final /* synthetic */ AccessibilityDelegateCompat val$compat;

            C07231(AccessibilityDelegateCompat accessibilityDelegateCompat) {
                this.val$compat = accessibilityDelegateCompat;
            }
        ...
        public Object newAccessiblityDelegateBridge(AccessibilityDelegateCompat compat) {
            return AccessibilityDelegateCompatJellyBean.newAccessibilityDelegateBridge(new C07231(compat));
        }
