...
public final class JsonStringEncoder {
    ...
    public byte[] encodeAsUTF8(String text) {
        ...
        while (inputPtr2 < inputEnd) {
            ...
            if (c < AccessibilityNodeInfoCompat.ACTION_PREVIOUS_HTML_ELEMENT) {
                ...
                outputPtr2 = outputPtr + 1;
                outputBuffer[outputPtr] = (byte) (((c >> 6) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                outputPtr = outputPtr2;
                inputPtr = inputPtr2;
            } else {
                if (c > SURR1_LAST) {
                ...
                outputPtr2 = outputPtr + 1;
                outputBuffer[outputPtr] = (byte) (((c >> 12) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            ...
            outputPtr2 = outputPtr + 1;
            outputBuffer[outputPtr] = (byte) ((c & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            outputPtr = outputPtr2;
            inputPtr2 = inputPtr;
        }
        inputPtr = inputPtr2;
    ...
    private static int _convert(int p1, int p2) {
        if (p2 >= SURR2_FIRST && p2 <= SURR2_LAST) {
            return (Cast.MAX_MESSAGE_LENGTH + ((p1 - SURR1_FIRST) << 10)) + (p2 - SURR2_FIRST);
        }
