...
public final class UTF8Writer extends Writer {
        ...
        if (len >= 2) {
            ...
            while (off2 < len) {
                ...
                if (c < AccessibilityNodeInfoCompat.ACTION_PREVIOUS_HTML_ELEMENT) {
                    ...
                    outPtr2 = outPtr + 1;
                    outBuf[outPtr] = (byte) ((c & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                    outPtr = outPtr2;
                    off = off2;
                    ...
                    outPtr2 = outPtr + 1;
                    outBuf[outPtr] = (byte) (((c >> 6) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                    outPtr = outPtr2 + 1;
                    outBuf[outPtr2] = (byte) ((c & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                } else {
                    if (c > SURR1_LAST) {
                    ...
                    outPtr2 = outPtr + 1;
                    outBuf[outPtr] = (byte) (((c >> 12) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                    outPtr = outPtr2 + 1;
                    outBuf[outPtr2] = (byte) (((c >> 6) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                    outPtr2 = outPtr + 1;
                    outBuf[outPtr] = (byte) ((c & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
                    outPtr = outPtr2;
                }
    ...
    public void write(int c) throws IOException {
        ...
        if (c < AccessibilityNodeInfoCompat.ACTION_PREVIOUS_HTML_ELEMENT) {
            ...
            i2 = i3 + 1;
            this._outBuffer[i3] = (byte) ((c & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
        } else if (c <= GameRequest.TYPE_ALL) {
            i3 = i2 + 1;
            this._outBuffer[i2] = (byte) ((c >> 12) | 224);
            i2 = i3 + 1;
            this._outBuffer[i3] = (byte) (((c >> 6) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            i3 = i2 + 1;
            this._outBuffer[i2] = (byte) ((c & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            i2 = i3;
        } else {
            if (c > 1114111) {
                illegalSurrogate(c);
            ...
            i2 = i3 + 1;
            this._outBuffer[i3] = (byte) (((c >> 12) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            i3 = i2 + 1;
            this._outBuffer[i2] = (byte) (((c >> 6) & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
            i2 = i3 + 1;
            this._outBuffer[i3] = (byte) ((c & 63) | TransportMediator.FLAG_KEY_MEDIA_NEXT);
        }
        this._outPtr = i2;
    ...
    protected int convertSurrogate(int secondPart) throws IOException {
        ...
        if (secondPart >= SURR2_FIRST && secondPart <= SURR2_LAST) {
            return (Cast.MAX_MESSAGE_LENGTH + ((firstPart - SURR1_FIRST) << 10)) + (secondPart - SURR2_FIRST);
        }
