...
public class UnsupportedUrlFragment extends GalleryViewerFragment {
    ...
    public View createFragmentView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(C0065R.layout.error_view, container, false);
        ((ErrorView) view.findViewById(C0065R.id.error_view)).show(DisplayError.UNSUPPORTED_URL, "Want this website right now? Just contact me below and I'll get cracking!", getUrl());
        return view;
    }
