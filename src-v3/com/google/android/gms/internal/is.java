...
import com.google.android.gms.internal.ih.C0405e;
...
public final class is extends C0251b implements Person {
    ...
    public Image getImage() {
        return new C1388c(getString("image"));
    }
    ...
    public int getObjectType() {
        return C0405e.bi(getString("objectType"));
    }
    ...
    public Person jS() {
        return new ih(getDisplayName(), getId(), (C1388c) getImage(), getObjectType(), getUrl());
    }
}
