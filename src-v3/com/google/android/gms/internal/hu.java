...
public interface hu extends IInterface {
    ...
    public static abstract class C0917a extends Binder implements hu {

        /* renamed from: com.google.android.gms.internal.hu.a.a */
        private static class C0916a implements hu {
            private IBinder kn;
            ...
            public void m2288a(int i, Bundle bundle, int i2, Intent intent) throws RemoteException {
        ...
        public static hu aL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof hu)) ? new C0916a(iBinder) : (hu) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case Std.STD_FILE /*1*/:
                    ...
                    m1075a(data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt(), data.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(data) : null);
    ...
    void m1075a(int i, Bundle bundle, int i2, Intent intent) throws RemoteException;
}
