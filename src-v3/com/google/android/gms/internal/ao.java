...
public interface ao extends IInterface {
    ...
    public static abstract class C0829a extends Binder implements ao {

        /* renamed from: com.google.android.gms.internal.ao.a.a */
        private static class C0828a implements ao {
            private IBinder kn;
        ...
        public static ao m2014e(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ao)) ? new C0828a(iBinder) : (ao) queryLocalInterface;
        }
