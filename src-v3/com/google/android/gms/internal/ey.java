...
public final class ey {
    public static Bitmap m912a(Bitmap bitmap) {
        int i = 0;
        if (bitmap == null) {
            return null;
        }
    ...
    private static Bitmap m913a(Drawable drawable) {
        if (drawable == null) {
            return null;
        }
    ...
    public static Drawable m914a(Resources resources, Drawable drawable) {
        return new BitmapDrawable(resources, m912a(m913a(drawable)));
    }
}
