...
public interface ar extends IInterface {
    ...
    public static abstract class C0835a extends Binder implements ar {

        /* renamed from: com.google.android.gms.internal.ar.a.a */
        private static class C0834a implements ar {
            private IBinder kn;
        ...
        public static ar m2025h(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAppEventListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ar)) ? new C0834a(iBinder) : (ar) queryLocalInterface;
        }
