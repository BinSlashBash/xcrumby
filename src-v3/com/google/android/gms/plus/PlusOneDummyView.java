...
public class PlusOneDummyView extends FrameLayout {
    ...
    private static class C1042a implements C0474d {
        private Context mContext;

        private C1042a(Context context) {
    ...
    private static class C1043b implements C0474d {
        private Context mContext;

        private C1043b(Context context) {
            this.mContext = context;
        }
    ...
    private static class C1044c implements C0474d {
        private Context mContext;

        private C1044c(Context context) {
            this.mContext = context;
        }
    ...
    private C0474d iJ() {
        C0474d c1043b = new C1043b(null);
        if (!c1043b.isValid()) {
            c1043b = new C1044c(null);
        }
        return !c1043b.isValid() ? new C1042a(null) : c1043b;
    }
}
