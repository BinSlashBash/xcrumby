...
public interface C0446p extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.p.a */
    public static abstract class C1005a extends Binder implements C0446p {

        /* renamed from: com.google.android.gms.maps.internal.p.a.a */
        private static class C1004a implements C0446p {
            private IBinder kn;
        ...
        public static C0446p as(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0446p)) ? new C1004a(iBinder) : (C0446p) queryLocalInterface;
        }
