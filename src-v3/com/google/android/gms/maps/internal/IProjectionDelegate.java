...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class C0967a extends Binder implements IProjectionDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IProjectionDelegate.a.a */
        private static class C0966a implements IProjectionDelegate {
            private IBinder kn;
            ...
            public LatLng fromScreenLocation(C0306d point) throws RemoteException {
                LatLng latLng = null;
            ...
            public C0306d toScreenLocation(LatLng location) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IProjectionDelegate");
        ...
        public static IProjectionDelegate av(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IProjectionDelegate)) ? new C0966a(iBinder) : (IProjectionDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case Std.STD_FILE /*1*/:
                    ...
                    LatLng fromScreenLocation = fromScreenLocation(C0820a.m1755K(data.readStrongBinder()));
                ...
                case Std.STD_URL /*2*/:
                    data.enforceInterface("com.google.android.gms.maps.internal.IProjectionDelegate");
                    C0306d toScreenLocation = toScreenLocation(data.readInt() != 0 ? LatLng.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
    ...
    LatLng fromScreenLocation(C0306d c0306d) throws RemoteException;

    VisibleRegion getVisibleRegion() throws RemoteException;

    C0306d toScreenLocation(LatLng latLng) throws RemoteException;
}
