...
public interface IStreetViewPanoramaFragmentDelegate extends IInterface {
    ...
    public static abstract class C0971a extends Binder implements IStreetViewPanoramaFragmentDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate.a.a */
        private static class C0970a implements IStreetViewPanoramaFragmentDelegate {
            private IBinder kn;

            C0970a(IBinder iBinder) {
                this.kn = iBinder;
            }
            ...
            public void onInflate(C0306d activityWrapper, StreetViewPanoramaOptions options, Bundle savedInstanceState) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
        ...
        public static IStreetViewPanoramaFragmentDelegate ay(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IStreetViewPanoramaFragmentDelegate)) ? new C0970a(iBinder) : (IStreetViewPanoramaFragmentDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case Std.STD_URL /*2*/:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
                    onInflate(C0820a.m1755K(data.readStrongBinder()), data.readInt() != 0 ? StreetViewPanoramaOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
                    return true;
                case Std.STD_URI /*3*/:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaFragmentDelegate");
    ...
    void onInflate(C0306d c0306d, StreetViewPanoramaOptions streetViewPanoramaOptions, Bundle bundle) throws RemoteException;
