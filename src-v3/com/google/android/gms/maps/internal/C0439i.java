...
public interface C0439i extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.i.a */
    public static abstract class C0991a extends Binder implements C0439i {

        /* renamed from: com.google.android.gms.maps.internal.i.a.a */
        private static class C0990a implements C0439i {
            private IBinder kn;
        ...
        public static C0439i al(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0439i)) ? new C0990a(iBinder) : (C0439i) queryLocalInterface;
        }
