...
public interface IPolylineDelegate extends IInterface {
    ...
    public static abstract class C1014a extends Binder implements IPolylineDelegate {

        /* renamed from: com.google.android.gms.maps.model.internal.IPolylineDelegate.a.a */
        private static class C1013a implements IPolylineDelegate {
            private IBinder kn;

            C1013a(IBinder iBinder) {
                this.kn = iBinder;
            }
        ...
        public static IPolylineDelegate aI(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IPolylineDelegate)) ? new C1013a(iBinder) : (IPolylineDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case GamesStatusCodes.STATUS_TIMEOUT /*15*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    isVisible = equalsRemote(C1014a.aI(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
