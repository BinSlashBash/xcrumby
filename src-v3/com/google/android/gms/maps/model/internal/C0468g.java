...
public interface C0468g extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.g.a */
    public static abstract class C1028a extends Binder implements C0468g {

        /* renamed from: com.google.android.gms.maps.model.internal.g.a.a */
        private static class C1027a implements C0468g {
            private IBinder kn;
            ...
            public boolean m2388a(C0468g c0468g) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    obtain.writeStrongBinder(c0468g != null ? c0468g.asBinder() : null);
        ...
        public static C0468g aH(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0468g)) ? new C1027a(iBinder) : (C0468g) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case C0065R.styleable.TwoWayView_android_focusable /*19*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    isVisible = m1288a(C1028a.aH(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
    ...
    boolean m1288a(C0468g c0468g) throws RemoteException;
