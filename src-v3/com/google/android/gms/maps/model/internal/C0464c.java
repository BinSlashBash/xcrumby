...
public interface C0464c extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.c.a */
    public static abstract class C1020a extends Binder implements C0464c {

        /* renamed from: com.google.android.gms.maps.model.internal.c.a.a */
        private static class C1019a implements C0464c {
            private IBinder kn;
            ...
            public void m2381a(float f, float f2) throws RemoteException {
            ...
            public boolean m2382a(C0464c c0464c) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    obtain.writeStrongBinder(c0464c != null ? c0464c.asBinder() : null);
            ...
            public void m2383k(C0306d c0306d) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
        ...
        public static C0464c aD(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0464c)) ? new C1019a(iBinder) : (C0464c) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case Std.STD_CURRENCY /*6*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    m1281a(data.readFloat(), data.readFloat());
                    reply.writeNoException();
                    return true;
                ...
                case C0065R.styleable.TwoWayView_android_focusable /*19*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    isVisible = m1282a(C1020a.aD(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
                ...
                case C0065R.styleable.TwoWayView_android_visibility /*21*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    m1283k(C0820a.m1755K(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void m1281a(float f, float f2) throws RemoteException;

    boolean m1282a(C0464c c0464c) throws RemoteException;
    ...
    void m1283k(C0306d c0306d) throws RemoteException;
