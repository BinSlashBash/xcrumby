...
public final class CastMediaControlIntent {
    ...
    private static String m83a(String str, String str2, Collection<String> collection) throws IllegalArgumentException {
        StringBuffer stringBuffer = new StringBuffer(str);
        if (str2 != null) {
            if (str2.matches("[A-F0-9]+")) {
                stringBuffer.append(DeviceFragment.REGEX_BASE).append(str2);
            } else {
        ...
        if (collection != null) {
            ...
            for (String str3 : collection) {
                if (!TextUtils.isEmpty(str3)) {
                    if (str3.trim().equals(UnsupportedUrlFragment.DISPLAY_NAME)) {
                    }
                }
                throw new IllegalArgumentException("Namespaces must not be null or empty");
            }
            if (str2 == null) {
                stringBuffer.append(DeviceFragment.REGEX_BASE);
            }
            stringBuffer.append(DeviceFragment.REGEX_BASE).append(TextUtils.join(",", collection));
        }
    ...
    public static String categoryForCast(String applicationId) throws IllegalArgumentException {
        if (applicationId != null) {
            return m83a(CATEGORY_CAST, applicationId, null);
        }
    ...
    public static String categoryForCast(String applicationId, Collection<String> namespaces) {
        if (applicationId == null) {
            ...
            return m83a(CATEGORY_CAST, applicationId, namespaces);
        } else {
    ...
    public static String categoryForCast(Collection<String> namespaces) throws IllegalArgumentException {
        if (namespaces != null) {
            return m83a(CATEGORY_CAST, null, namespaces);
        }
        throw new IllegalArgumentException("namespaces cannot be null");
    }

    public static String categoryForRemotePlayback() {
        return m83a("com.google.android.gms.cast.CATEGORY_CAST_REMOTE_PLAYBACK", null, null);
    }

    public static String categoryForRemotePlayback(String applicationId) throws IllegalArgumentException {
        if (!TextUtils.isEmpty(applicationId)) {
            return m83a("com.google.android.gms.cast.CATEGORY_CAST_REMOTE_PLAYBACK", applicationId, null);
        }
