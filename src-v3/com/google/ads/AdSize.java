...
public final class AdSize {
    ...
    private final com.google.android.gms.ads.AdSize f11c;
    ...
    public boolean equals(Object other) {
        ...
        return this.f11c.equals(((AdSize) other).f11c);
    }
        ...
        if (options != null) {
            ...
            while (i < length) {
                ...
                if (isSizeAppropriate(width2, height2)) {
                    ...
                    if (f2 > GalleryViewer.PROGRESS_COMPLETED) {
                        f2 = GalleryViewer.PROGRESS_COMPLETED / f2;
                    }
                    if (f2 > f) {
                        adSize2 = adSize3;
                        i++;
    ...
    public int getHeight() {
        return this.f11c.getHeight();
    }

    public int getHeightInPixels(Context context) {
        return this.f11c.getHeightInPixels(context);
    }

    public int getWidth() {
        return this.f11c.getWidth();
    }

    public int getWidthInPixels(Context context) {
        return this.f11c.getWidthInPixels(context);
    }

    public int hashCode() {
        return this.f11c.hashCode();
    }

    public boolean isAutoHeight() {
        return this.f11c.isAutoHeight();
    }
