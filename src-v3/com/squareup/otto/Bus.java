...
public class Bus {
    ...
    class C06021 extends ThreadLocal<ConcurrentLinkedQueue<EventWithHandler>> {
        C06021() {
        }
    ...
    class C06032 extends ThreadLocal<Boolean> {
        C06032() {
        }
    ...
    Bus(ThreadEnforcer enforcer, String identifier, HandlerFinder handlerFinder) {
        ...
        this.eventsToDispatch = new C06021();
        this.isDispatching = new C06032();
