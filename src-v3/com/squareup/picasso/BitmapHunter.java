...
abstract class BitmapHunter implements Runnable {
    ...
    static class C06041 extends ThreadLocal<StringBuilder> {
        C06041() {
        }
    ...
    static class C06052 implements Runnable {
        final /* synthetic */ StringBuilder val$builder;

        C06052(StringBuilder stringBuilder) {
    ...
    static class C06063 implements Runnable {
        final /* synthetic */ Transformation val$transformation;

        C06063(Transformation transformation) {
    ...
    static class C06074 implements Runnable {
        final /* synthetic */ Transformation val$transformation;

        C06074(Transformation transformation) {
            this.val$transformation = transformation;
        }
    ...
    static Bitmap applyCustomTransformations(List<Transformation> transformations, Bitmap result) {
        ...
        while (i < count) {
            ...
            if (newResult == null) {
                ...
                Picasso.HANDLER.post(new C06052(builder));
                return null;
            } else if (newResult == result && result.isRecycled()) {
                Picasso.HANDLER.post(new C06063(transformation));
                return null;
            } else if (newResult == result || result.isRecycled()) {
                result = newResult;
                i++;
            } else {
                Picasso.HANDLER.post(new C06074(transformation));
                return null;
            }
        }
        return result;
