...
public class RequestCreator {
    ...
    static class C06121 implements Runnable {
        final /* synthetic */ AtomicInteger val$id;
        final /* synthetic */ CountDownLatch val$latch;

        C06121(AtomicInteger atomicInteger, CountDownLatch countDownLatch) {
    ...
    static class C06132 implements Runnable {
        final /* synthetic */ InterruptedException val$e;

        C06132(InterruptedException interruptedException) {
    ...
    private static int getRequestId() {
        ...
        Picasso.HANDLER.post(new C06121(id, latch));
        try {
            latch.await();
        } catch (InterruptedException e) {
            Picasso.HANDLER.post(new C06132(e));
        }
        return id.get();
    }
