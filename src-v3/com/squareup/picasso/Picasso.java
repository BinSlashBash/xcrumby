...
public class Picasso {
    ...
    static class C06091 extends Handler {
        C06091(Looper x0) {
            super(x0);
        }
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    this.handler.post(new C06101(e2));
                    return;
                }
            }
        }
    ...
    public interface RequestTransformer {
        ...
        static class C11671 implements RequestTransformer {
            C11671() {
            }
    ...
    static {
        HANDLER = new C06091(Looper.getMainLooper());
        singleton = null;
    }
    ...
    private void deliverAction(Bitmap result, LoadedFrom from, Action action, Exception exception) {
