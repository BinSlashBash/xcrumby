...
class tree_tester(object):
	def __init__(self, database=None):
		self.database = database

	def test_multiple_finds(self, tree, *args):
		for search in args:
			results = []
			start = current_milli_time()
			results = self.query(search, tree)
			print "============================"
			print search, "\t\t Took ", current_milli_time()  - start, " milliseconds"
			pprint(results)

	def query(self, search, compiled_tree):
		results = []
		self.find(search, compiled_tree, results, "")
...
def main():
	...
	url_maker.test_multiple_finds("touhou", "whack a cat", "australia", "dog", "east")
	name_maker.test_multiple_finds("touhou", "whack a cat", "precure", "dog", "gave", "when", "hen", "onel", "ea st me e ts w")

	name_maker.test_multiple_finds(pruning=True, "touhou", "whack a cat", "precure", "dog", "gave", "when", "hen", "onel", "ea st me e ts w")
