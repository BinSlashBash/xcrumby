...
class tree_generator(object):
	...
	def test_multiple_finds(self, pruning=False, *args):
		for search in args:
			results = []
			start = current_milli_time()
			compiled_tree = self.compiled_tree
			if pruning: 
				pass
			results = self.query(search, compiled_tree)
			print "============================"
...
def main():
	...
	name_maker.test_multiple_finds("touhou", "whack a cat", "precure", "dog", "gave", "when", "hen", "onel", "ea st me e ts w", "meets")
