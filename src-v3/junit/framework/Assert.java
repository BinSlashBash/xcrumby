...
public class Assert {
    ...
    public static void failSame(String message) {
        fail((message != null ? message + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR : UnsupportedUrlFragment.DISPLAY_NAME) + "expected not same");
    }

    public static void failNotSame(String message, Object expected, Object actual) {
        fail((message != null ? message + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR : UnsupportedUrlFragment.DISPLAY_NAME) + "expected same:<" + expected + "> was not:<" + actual + ">");
    }
