  ...
  extends BaseModel
{
  ...
  public static void loadClientConfig(final Callback<ClientConfig> paramCallback)
  {
    ...
    {
      paramCallback.onError(new RestResult(new Exception("Uservoice config not loaded.")));
      return;
    }
    ...
    {
      str2 = String.format("uv-client-%s-%s-%s", new Object[] { UserVoice.getVersion(), Session.getInstance().getConfig().getSite(), Session.getInstance().getConfig().getKey() });
    ...
    throws JSONException
  {
    ...
    if (paramJSONObject.has("display_suggestions_by_rank")) {
      this.displaySuggestionsByRank = paramJSONObject.getBoolean("display_suggestions_by_rank");
    }
    ...
    throws JSONException
  {
    ...
    paramJSONObject.put("display_suggestions_by_rank", this.displaySuggestionsByRank);
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/com/uservoice/uservoicesdk/model/ClientConfig.class
