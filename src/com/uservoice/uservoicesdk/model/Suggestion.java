  ...
  extends BaseModel
{
    ...
    throws JSONException
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      if (paramJSONObject.has("rank")) {
        this.rank = paramJSONObject.getInt("rank");
      }
      return;
    }
  }
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/com/uservoice/uservoicesdk/model/Suggestion.class
