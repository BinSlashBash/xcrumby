  ...
  extends DialogFragmentBugfixed
{
  ...
  private void displaySuggestion(View paramView, Suggestion paramSuggestion)
  {
    ...
    for (;;)
    {
      ...
      ((TextView)paramView.findViewById(R.id.uv_subscriber_count)).setText(String.format(paramView.getContext().getResources().getString(R.string.uv_ranked), new Object[] { paramSuggestion.getRankString() }));
      return;
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/com/uservoice/uservoicesdk/dialog/SuggestionDialogFragment.class
