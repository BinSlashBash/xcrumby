  ...
  extends InstantAnswersAdapter
{
  ...
  {
    final Object localObject2 = paramView;
    int i = getItemViewType(paramInt);
    Object localObject1 = localObject2;
    if (localObject2 == null)
    {
      if (i == this.CUSTOM_TEXT_FIELD) {
        localObject1 = this.inflater.inflate(R.layout.uv_text_field_item, null);
      }
    }
    else
    {
      ...
      paramView = (TextView)((View)localObject1).findViewById(R.id.uv_header_text);
      paramViewGroup = (EditText)((View)localObject1).findViewById(R.id.uv_text_field);
      localObject2 = (CustomField)getItem(paramInt);
      String str = (String)this.customFieldValues.get(((CustomField)localObject2).getName());
      paramView.setText(((CustomField)localObject2).getName());
      ...
      paramViewGroup.setOnFocusChangeListener(new View.OnFocusChangeListener()
      {
        public void onFocusChange(View paramAnonymousView, boolean paramAnonymousBoolean)
        {
          if (!paramAnonymousBoolean) {
            ContactAdapter.this.customFieldValues.put(localObject2.getName(), paramViewGroup.getText().toString());
          }
        }
      });
    }
    for (;;)
    {
      ...
      {
        localObject1 = this.inflater.inflate(R.layout.uv_select_field_item, null);
        break;
      }
      ...
      ((TextView)((View)localObject1).findViewById(R.id.uv_header_text)).setText(paramView.getName());
      localObject2 = (Spinner)((View)localObject1).findViewById(R.id.uv_select_field);
      ...
      ((Spinner)localObject2).setAdapter(new SpinnerAdapter(this.context, paramView.getPredefinedValues()));
      if ((paramViewGroup != null) && (paramView.getPredefinedValues().contains(paramViewGroup))) {
        ((Spinner)localObject2).setSelection(paramView.getPredefinedValues().indexOf(paramViewGroup) + 1);
      }
    }
    label319:
    return super.getView(paramInt, (View)localObject1, paramViewGroup);
  }
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/com/uservoice/uservoicesdk/ui/ContactAdapter.class
