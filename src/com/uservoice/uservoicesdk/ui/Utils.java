...
public class Utils
{
  ...
  public static void showModel(FragmentActivity paramFragmentActivity, BaseModel paramBaseModel, String paramString)
  {
    ...
    paramString = new Intent(paramFragmentActivity, TopicActivity.class);
    paramString.putExtra("topic", (Topic)paramBaseModel);
    paramFragmentActivity.startActivity(paramString);
  }
}


/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/com/uservoice/uservoicesdk/ui/Utils.class
