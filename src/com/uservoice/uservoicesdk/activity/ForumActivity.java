  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    setListAdapter(new PaginatedAdapter(this, R.layout.uv_suggestion_item, this.suggestions)
    {
      ...
      protected void customizeLayout(View paramAnonymousView, Suggestion paramAnonymousSuggestion)
      {
        ...
        TextView localTextView = (TextView)paramAnonymousView.findViewById(R.id.uv_subscriber_count);
        if (Session.getInstance().getClientConfig().shouldDisplaySuggestionsByRank()) {
          localTextView.setText(paramAnonymousSuggestion.getRankString());
        }
        for (;;)
        {
          localTextView = (TextView)paramAnonymousView.findViewById(R.id.uv_suggestion_status);
          ...
          return;
          localTextView.setText(String.valueOf(paramAnonymousSuggestion.getNumberOfSubscribers()));
        }
    ...
    getListView().setOnItemClickListener(new AdapterView.OnItemClickListener()
    {
      public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
      {
        ...
        new SuggestionDialogFragment((Suggestion)ForumActivity.this.getModelAdapter().getItem(paramAnonymousInt), null).show(ForumActivity.this.getSupportFragmentManager(), "SuggestionDialogFragment");
      }
    });
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/com/uservoice/uservoicesdk/activity/ForumActivity.class
