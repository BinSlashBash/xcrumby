    ...
    private boolean areAllListInfosSelectable(ArrayList<HeaderGridView.FixedViewInfo> paramArrayList)
    {
      if (paramArrayList != null)
      {
        ...
        while (paramArrayList.hasNext()) {
          if (!((HeaderGridView.FixedViewInfo)paramArrayList.next()).isSelectable) {
            return false;
          }
        }
      }
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/com/crumby/lib/widget/thirdparty/HeaderGridView.class
