    ...
    throws IOException
  {
    ...
    catch (IllegalArgumentException paramJsonParser)
    {
      ...
      if (paramJsonParser != null) {
        localObject = "not a valid textual representation" + "problem: " + paramJsonParser.getMessage();
      }
      paramDeserializationContext = paramDeserializationContext.weirdStringException(str, this._valueClass, (String)localObject);
      if (paramJsonParser != null) {
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/com/fasterxml/jackson/databind/deser/std/FromStringDeserializer.class
