  ...
  extends ParserBase
{
    ...
    throws IOException
  {
    ...
    if ((paramInt3 == 45) || (paramInt3 == 43))
    {
      ...
      {
        this._inputPtr = paramInt2;
        return _parseNumber2(false, paramInt2);
      }
      arrayOfChar = this._inputBuffer;
      paramInt1 = i + 1;
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/com/fasterxml/jackson/core/json/ReaderBasedJsonParser.class
