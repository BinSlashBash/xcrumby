...
public final class ByteSourceJsonBootstrapper
{
  ...
  public JsonParser constructParser(int paramInt1, ObjectCodec paramObjectCodec, BytesToNameCanonicalizer paramBytesToNameCanonicalizer, CharsToNameCanonicalizer paramCharsToNameCanonicalizer, int paramInt2)
    throws IOException
  {
    if ((detectEncoding() == JsonEncoding.UTF8) && (JsonFactory.Feature.CANONICALIZE_FIELD_NAMES.enabledIn(paramInt2)))
    {
      ...
      return new UTF8StreamJsonParser(this._context, paramInt1, this._in, paramObjectCodec, paramBytesToNameCanonicalizer, this._inputBuffer, this._inputPtr, this._inputEnd, this._bufferRecyclable);
    }
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/com/fasterxml/jackson/core/json/ByteSourceJsonBootstrapper.class
