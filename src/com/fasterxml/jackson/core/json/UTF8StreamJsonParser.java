  ...
  extends ParserBase
{
    ...
    throws IOException
  {
    ...
    int n = 1;
    int i1 = this._inputPtr + arrayOfChar.length;
    j = m;
    k = n;
    i = i1;
    ...
    throws IOException
  {
    ...
    int j = 1;
    i = this._inputPtr + arrayOfChar.length;
    if (i > this._inputEnd) {
      i = this._inputEnd;
    }
    for (;;)
    ...
    throws IOException
  {
    ...
    while (this._inputPtr + 4 <= this._inputEnd)
    {
      ...
      if (arrayOfInt[i] != 0)
      {
        ...
        return parseEscapedName(this._quadBuffer, paramInt1, paramInt2, i, 1);
      }
      ...
      if (arrayOfInt[i] != 0)
      {
        ...
        return parseEscapedName(this._quadBuffer, paramInt1, paramInt2, i, 2);
      }
      paramInt2 = paramInt2 << 8 | i;
      i = this._inputPtr;
      this._inputPtr = (i + 1);
      ...
      if (arrayOfInt[i] != 0)
      {
        ...
        return parseEscapedName(this._quadBuffer, paramInt1, paramInt2, i, 3);
      }
      i = paramInt2 << 8 | i;
      paramInt2 = this._inputPtr;
      this._inputPtr = (paramInt2 + 1);
      ...
      {
        if (paramInt2 == 34) {
          return findName(this._quadBuffer, paramInt1, i, 4);
        }
        return parseEscapedName(this._quadBuffer, paramInt1, i, paramInt2, 4);
      }
      if (paramInt1 >= this._quadBuffer.length) {
        this._quadBuffer = growArrayBy(this._quadBuffer, paramInt1);
      }
      this._quadBuffer[paramInt1] = i;
      paramInt1 += 1;
    }
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/com/fasterxml/jackson/core/json/UTF8StreamJsonParser.class
