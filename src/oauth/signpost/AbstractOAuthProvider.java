  ...
  implements OAuthProvider
{
    ...
    throws OAuthMessageSignerException, OAuthNotAuthorizedException, OAuthExpectationFailedException, OAuthCommunicationException
  {
    ...
    //   21: aload_3
    //   22: iconst_1
    //   23: invokevirtual 149	oauth/signpost/http/HttpParameters:putAll	([Ljava/lang/String;Z)V
    //   26: aload 4
    //   28: ldc -90
    //   30: aload_2
    //   31: iconst_1
    //   32: invokevirtual 155	oauth/signpost/http/HttpParameters:put	(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    //   35: pop
    //   36: aload_0
    //   37: aload_1
    //   38: aload_0
    ...
    //   42: aload 4
    //   44: invokevirtual 159	oauth/signpost/AbstractOAuthProvider:retrieveToken	(Loauth/signpost/OAuthConsumer;Ljava/lang/String;Loauth/signpost/http/HttpParameters;)V
    //   47: aload_0
    //   48: getfield 39	oauth/signpost/AbstractOAuthProvider:responseParameters	Loauth/signpost/http/HttpParameters;
    //   51: ldc -88
    //   53: invokevirtual 66	oauth/signpost/http/HttpParameters:getFirst	(Ljava/lang/Object;)Ljava/lang/String;
    //   56: astore_3
    //   57: aload_0
    //   58: getfield 39	oauth/signpost/AbstractOAuthProvider:responseParameters	Loauth/signpost/http/HttpParameters;
    //   61: ldc -88
    //   63: invokevirtual 172	oauth/signpost/http/HttpParameters:remove	(Ljava/lang/Object;)Ljava/util/SortedSet;
    //   66: pop
    //   67: aload_0
    //   68: getstatic 178	java/lang/Boolean:TRUE	Ljava/lang/Boolean;
    //   71: invokevirtual 179	java/lang/Boolean:toString	()Ljava/lang/String;
    //   74: aload_3
    //   75: invokevirtual 185	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   78: putfield 124	oauth/signpost/AbstractOAuthProvider:isOAuth10a	Z
    //   81: aload_0
    //   82: getfield 124	oauth/signpost/AbstractOAuthProvider:isOAuth10a	Z
    //   85: ifeq +33 -> 118
    //   88: aload_0
    //   89: getfield 34	oauth/signpost/AbstractOAuthProvider:authorizationWebsiteUrl	Ljava/lang/String;
    //   92: iconst_2
    //   93: anewarray 181	java/lang/String
    //   96: dup
    //   97: iconst_0
    //   98: ldc -69
    //   100: aastore
    ...
    //   109: aastore
    //   110: invokestatic 193	oauth/signpost/OAuth:addQueryParameters	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    //   113: astore_1
    //   114: aload_0
    //   115: monitorexit
    //   116: aload_1
    ...
    //   122: iconst_4
    //   123: anewarray 181	java/lang/String
    //   126: dup
    //   127: iconst_0
    //   128: ldc -69
    //   130: aastore
    ...
    //   147: aload_2
    //   148: aastore
    //   149: invokestatic 193	oauth/signpost/OAuth:addQueryParameters	(Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    //   152: astore_1
    //   153: goto -39 -> 114
    //   156: astore_1
    //   157: aload_0
    ...
    throws OAuthMessageSignerException, OAuthCommunicationException, OAuthNotAuthorizedException, OAuthExpectationFailedException
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 195	oauth/signpost/AbstractOAuthProvider:getRequestHeaders	()Ljava/util/Map;
    //   4: astore 18
    //   6: aload_1
    //   7: invokeinterface 198 1 0
    //   12: ifnull +12 -> 24
    //   15: aload_1
    //   16: invokeinterface 201 1 0
    //   21: ifnonnull +13 -> 34
    //   24: new 134	oauth/signpost/exception/OAuthExpectationFailedException
    //   27: dup
    //   28: ldc -53
    //   30: invokespecial 145	oauth/signpost/exception/OAuthExpectationFailedException:<init>	(Ljava/lang/String;)V
    //   33: athrow
    //   34: aconst_null
    //   35: astore 6
    //   37: aconst_null
    ...
    //   74: aload_0
    //   75: aload_2
    //   76: invokevirtual 205	oauth/signpost/AbstractOAuthProvider:createRequest	(Ljava/lang/String;)Loauth/signpost/http/HttpRequest;
    //   79: astore_2
    //   80: aload_2
    //   81: astore 8
    //   83: aload 14
    ...
    //   106: astore 13
    //   108: aload 18
    //   110: invokeinterface 211 1 0
    //   115: invokeinterface 217 1 0
    //   120: astore 19
    //   122: aload_2
    //   123: astore 8
    //   125: aload 14
    ...
    //   186: astore 13
    //   188: aload 19
    //   190: invokeinterface 226 1 0
    //   195: checkcast 181	java/lang/String
    //   198: astore 20
    //   200: aload_2
    //   201: astore 8
    //   203: aload 14
    ...
    //   231: aload 18
    //   233: aload 20
    //   235: invokeinterface 230 2 0
    //   240: checkcast 181	java/lang/String
    //   243: invokeinterface 235 3 0
    //   248: goto -126 -> 122
    //   251: astore_1
    //   252: aload 8
    //   254: astore 6
    ...
    //   264: aload 6
    //   266: aload 7
    //   268: invokevirtual 237	oauth/signpost/AbstractOAuthProvider:closeConnection	(Loauth/signpost/http/HttpRequest;Loauth/signpost/http/HttpResponse;)V
    //   271: aload_1
    //   272: athrow
    //   273: aload_3
    //   274: ifnull +73 -> 347
    ...
    //   303: astore 13
    //   305: aload_3
    //   306: invokevirtual 240	oauth/signpost/http/HttpParameters:isEmpty	()Z
    //   309: ifne +38 -> 347
    //   312: aload_2
    //   313: astore 8
    //   315: aload 14
    ...
    //   373: astore 13
    //   375: aload_0
    //   376: getfield 128	oauth/signpost/AbstractOAuthProvider:listener	Loauth/signpost/OAuthProviderListener;
    //   379: ifnull +41 -> 420
    //   382: aload_2
    //   383: astore 8
    //   385: aload 14
    ...
    //   408: astore 13
    //   410: aload_0
    //   411: getfield 128	oauth/signpost/AbstractOAuthProvider:listener	Loauth/signpost/OAuthProviderListener;
    //   414: aload_2
    //   415: invokeinterface 250 2 0
    //   420: aload_2
    //   421: astore 8
    //   423: aload 14
    //   425: astore 9
    ...
    //   482: astore 13
    //   484: aload_0
    //   485: getfield 128	oauth/signpost/AbstractOAuthProvider:listener	Loauth/signpost/OAuthProviderListener;
    //   488: ifnull +41 -> 529
    //   491: aload_2
    //   492: astore 8
    //   494: aload 14
    ...
    //   517: astore 13
    //   519: aload_0
    //   520: getfield 128	oauth/signpost/AbstractOAuthProvider:listener	Loauth/signpost/OAuthProviderListener;
    //   523: aload_2
    //   524: invokeinterface 257 2 0
    //   529: aload_2
    //   530: astore 8
    //   532: aload 14
    //   534: astore 9
    ...
    //   557: aload_0
    //   558: aload_2
    //   559: invokevirtual 261	oauth/signpost/AbstractOAuthProvider:sendRequest	(Loauth/signpost/http/HttpRequest;)Loauth/signpost/http/HttpResponse;
    //   562: astore_3
    //   563: aload_2
    //   564: astore 8
    //   566: aload_3
    ...
    //   620: astore 13
    //   622: aload_0
    //   623: getfield 128	oauth/signpost/AbstractOAuthProvider:listener	Loauth/signpost/OAuthProviderListener;
    //   626: ifnull +40 -> 666
    //   629: aload_2
    //   630: astore 8
    //   632: aload_3
    ...
    //   651: astore 13
    //   653: aload_0
    //   654: getfield 128	oauth/signpost/AbstractOAuthProvider:listener	Loauth/signpost/OAuthProviderListener;
    //   657: aload_2
    //   658: aload_3
    //   659: invokeinterface 269 3 0
    //   664: istore 5
    //   666: iload 5
    //   668: ifeq +20 -> 688
    //   671: aload_0
    //   672: aload_2
    //   673: aload_3
    //   674: invokevirtual 237	oauth/signpost/AbstractOAuthProvider:closeConnection	(Loauth/signpost/http/HttpRequest;Loauth/signpost/http/HttpResponse;)V
    //   677: return
    //   678: astore_1
    //   679: new 98	oauth/signpost/exception/OAuthCommunicationException
    //   682: dup
    //   683: aload_1
    //   684: invokespecial 272	oauth/signpost/exception/OAuthCommunicationException:<init>	(Ljava/lang/Exception;)V
    //   687: athrow
    //   688: iload 4
    //   690: sipush 300
    ...
    //   721: iload 4
    //   723: aload_3
    //   724: invokevirtual 274	oauth/signpost/AbstractOAuthProvider:handleUnexpectedResponse	(ILoauth/signpost/http/HttpResponse;)V
    //   727: aload_2
    //   728: astore 8
    //   730: aload_3
    //   731: astore 9
    ...
    //   749: astore 13
    //   751: aload_3
    //   752: invokeinterface 80 1 0
    //   757: invokestatic 278	oauth/signpost/OAuth:decodeForm	(Ljava/io/InputStream;)Loauth/signpost/http/HttpParameters;
    //   760: astore 14
    //   762: aload_2
    //   763: astore 8
    //   765: aload_3
    ...
    //   786: aload 14
    //   788: ldc -69
    //   790: invokevirtual 66	oauth/signpost/http/HttpParameters:getFirst	(Ljava/lang/Object;)Ljava/lang/String;
    //   793: astore 15
    //   795: aload_2
    //   796: astore 8
    //   798: aload_3
    ...
    //   819: aload 14
    //   821: ldc_w 280
    //   824: invokevirtual 66	oauth/signpost/http/HttpParameters:getFirst	(Ljava/lang/Object;)Ljava/lang/String;
    //   827: astore 16
    //   829: aload_2
    //   830: astore 8
    //   832: aload_3
    ...
    //   853: aload 14
    //   855: ldc -69
    //   857: invokevirtual 172	oauth/signpost/http/HttpParameters:remove	(Ljava/lang/Object;)Ljava/util/SortedSet;
    //   860: pop
    //   861: aload_2
    //   862: astore 8
    //   864: aload_3
    ...
    //   885: aload 14
    //   887: ldc_w 280
    //   890: invokevirtual 172	oauth/signpost/http/HttpParameters:remove	(Ljava/lang/Object;)Ljava/util/SortedSet;
    //   893: pop
    //   894: aload_2
    //   895: astore 8
    //   897: aload_3
    ...
    //   918: aload_0
    //   919: aload 14
    //   921: invokevirtual 283	oauth/signpost/AbstractOAuthProvider:setResponseParameters	(Loauth/signpost/http/HttpParameters;)V
    //   924: aload 15
    //   926: ifnull +8 -> 934
    //   929: aload 16
    ...
    //   955: aload_3
    //   956: astore 13
    //   958: new 134	oauth/signpost/exception/OAuthExpectationFailedException
    //   961: dup
    //   962: ldc_w 285
    //   965: invokespecial 145	oauth/signpost/exception/OAuthExpectationFailedException:<init>	(Ljava/lang/String;)V
    //   968: athrow
    //   969: astore_1
    //   970: aload 10
    //   972: astore 6
    ...
    //   1005: aload 15
    //   1007: aload 16
    //   1009: invokeinterface 164 3 0
    //   1014: aload_0
    //   1015: aload_2
    //   1016: aload_3
    //   1017: invokevirtual 237	oauth/signpost/AbstractOAuthProvider:closeConnection	(Loauth/signpost/http/HttpRequest;Loauth/signpost/http/HttpResponse;)V
    //   1020: return
    //   1021: astore_1
    //   1022: new 98	oauth/signpost/exception/OAuthCommunicationException
    //   1025: dup
    //   1026: aload_1
    //   1027: invokespecial 272	oauth/signpost/exception/OAuthCommunicationException:<init>	(Ljava/lang/Exception;)V
    //   1030: athrow
    //   1031: astore_1
    //   1032: aload 12
    //   1034: astore 6
    //   1036: aload 13
    //   1038: astore 7
    //   1040: new 98	oauth/signpost/exception/OAuthCommunicationException
    //   1043: dup
    //   1044: aload_1
    //   1045: invokespecial 272	oauth/signpost/exception/OAuthCommunicationException:<init>	(Ljava/lang/Exception;)V
    //   1048: athrow
    //   1049: astore_1
    //   1050: new 98	oauth/signpost/exception/OAuthCommunicationException
    //   1053: dup
    //   1054: aload_1
    //   1055: invokespecial 272	oauth/signpost/exception/OAuthCommunicationException:<init>	(Ljava/lang/Exception;)V
    //   1058: athrow
    // Local variable table:
    //   start	length	slot	name	signature
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/oauth/signpost/AbstractOAuthProvider.class
