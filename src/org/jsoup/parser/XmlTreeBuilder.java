  ...
  extends TreeBuilder
{
  ...
  {
    Comment localComment2 = new Comment(paramComment.getData(), this.baseUri);
    Comment localComment1 = localComment2;
    Object localObject = localComment1;
    if (paramComment.bogus)
    {
      paramComment = localComment2.getData();
      localObject = localComment1;
      if (paramComment.length() > 1) {
        ...
        {
          localObject = new XmlDeclaration(paramComment.substring(1), localComment2.baseUri(), paramComment.startsWith("!"));
        }
      }
    }
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/org/jsoup/parser/XmlTreeBuilder.class
