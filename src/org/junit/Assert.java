...
public class Assert
{
  ...
  public static void assertEquals(String paramString, Object paramObject1, Object paramObject2)
  {
    ...
    if (((paramObject1 instanceof String)) && ((paramObject2 instanceof String)))
    {
      ...
      for (;;)
      {
        throw new ComparisonFailure(paramString, (String)paramObject1, (String)paramObject2);
      }
    }
...
/* Location:              /home/dev/Downloads/apk/dex2jar-2.0/crumby-dex2jar.jar!/org/junit/Assert.class
