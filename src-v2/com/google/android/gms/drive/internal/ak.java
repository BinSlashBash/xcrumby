...
implements Parcelable.Creator<RemoveEventListenerRequest> {
    static void a(RemoveEventListenerRequest removeEventListenerRequest, Parcel parcel, int n2) {
        int n3 = b.p(parcel);
        b.c(parcel, 1, removeEventListenerRequest.xH);
        b.a(parcel, 2, removeEventListenerRequest.Ew, n2, false);
    ...
    public RemoveEventListenerRequest Y(Parcel parcel) {
        ...
        return new RemoveEventListenerRequest(n4, driveId, n2);
    }

    public RemoveEventListenerRequest[] aC(int n2) {
        return new RemoveEventListenerRequest[n2];
    }
