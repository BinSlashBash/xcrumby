...
implements Parcelable.Creator<InstrumentInfo> {
    static void a(InstrumentInfo instrumentInfo, Parcel parcel, int n2) {
        n2 = b.p(parcel);
    ...
    public InstrumentInfo bd(Parcel parcel) {
        ...
        return new InstrumentInfo(n3, string3, string2);
    }

    public InstrumentInfo[] cp(int n2) {
        return new InstrumentInfo[n2];
    }
