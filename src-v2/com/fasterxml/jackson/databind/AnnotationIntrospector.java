...
Serializable {
    ...
    public Object findFilterId(AnnotatedClass annotatedClass) {
        return this.findFilterId((Annotated)annotatedClass);
    }
    ...
    public static class ReferenceProperty {
        ...
        public ReferenceProperty(Type type, String string2) {
            this._type = type;
            this._name = string2;
        }

        public static ReferenceProperty back(String string2) {
            return new ReferenceProperty(Type.BACK_REFERENCE, string2);
        }

        public static ReferenceProperty managed(String string2) {
            return new ReferenceProperty(Type.MANAGED_REFERENCE, string2);
        }
