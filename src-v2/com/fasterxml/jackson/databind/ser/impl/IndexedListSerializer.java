...
extends AsArraySerializerBase<List<?>> {
    public IndexedListSerializer(JavaType javaType, boolean bl2, TypeSerializer typeSerializer, BeanProperty beanProperty, JsonSerializer<Object> jsonSerializer) {
        super(List.class, javaType, bl2, typeSerializer, beanProperty, jsonSerializer);
    }
     ...
     */
    @Override
    public void serializeContents(List<?> var1_1, JsonGenerator var2_2, SerializerProvider var3_4) throws IOException, JsonGenerationException {
     ...
     * Exception decompiling
     */
    public void serializeContentsUsing(List<?> var1_1, JsonGenerator var2_2, SerializerProvider var3_3, JsonSerializer<Object> var4_4) throws IOException, JsonGenerationException {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
        // java.lang.IllegalStateException: Backjump on non jumping statement [] lbl17 : TryStatement: try { 1[TRYBLOCK]
     ...
     * Exception decompiling
     */
    public void serializeTypedContents(List<?> var1_1, JsonGenerator var2_2, SerializerProvider var3_4) throws IOException, JsonGenerationException {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
        // org.benf.cfr.reader.util.ConfusedCFRException: Tried to end blocks [0[TRYBLOCK]], but top level block is 3[WHILELOOP]
        // org.benf.cfr.reader.bytecode.analysis.opgraph.Op04StructuredStatement.processEndingBlocks(Op04StructuredStatement.java:394)
        // org.benf.cfr.reader.bytecode.analysis.opgraph.Op04StructuredStatement.buildNestedBlocks(Op04StructuredStatement.java:446)
