...
extends BeanDeserializerBase {
    ...
    public BeanAsArrayBuilderDeserializer(BeanDeserializerBase beanDeserializerBase, SettableBeanProperty[] arrsettableBeanProperty, AnnotatedMethod annotatedMethod) {
    ...
    protected Object _deserializeNonVanilla(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
        ...
        do {
            ...
            if (object != null && (class_ == null || object.visibleInView(class_))) {
                try {
                    object.deserializeSetAndReturn(jsonParser, deserializationContext, object2);
                }
    ...
    protected final Object _deserializeUsingPropertyBased(JsonParser var1_1, DeserializationContext var2_3) throws IOException, JsonProcessingException {
        ...
        while (var1_1.nextToken() != JsonToken.END_ARRAY) {
            ...
            if (var7_13 == null) {
                ...
                try {
                    var6_10 = var7_13.deserializeSetAndReturn((JsonParser)var1_1, var2_3, var5_9);
                }
                ...
                if (var12_15 != null) {
                    ...
                    if (var9_5.assignParameter(var12_15.getCreatorIndex(), var7_13)) {
                        try {
                            ...
                            if (var5_9.getClass() == this._beanType.getRawClass()) ** GOTO lbl39
                        }
    ...
    public Object deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
        ...
        do {
            ...
            if (settableBeanProperty != null) {
                try {
                    Object object2;
                    object = object2 = settableBeanProperty.deserializeSetAndReturn(jsonParser, deserializationContext, object);
                }
                catch (Exception var6_8) {
                    this.wrapAndThrow((Throwable)var6_8, object, settableBeanProperty.getName(), deserializationContext);
                }
            } else {
                jsonParser.skipChildren();
            }
