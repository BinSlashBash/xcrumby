...
extends GalleryViewerFragment {
    ...
    public View createFragmentView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        layoutInflater = layoutInflater.inflate(2130903066, viewGroup, false);
        ((ErrorView)layoutInflater.findViewById(2131492959)).show(DisplayError.UNSUPPORTED_URL, "Want this website right now? Just contact me below and I'll get cracking!", this.getUrl());
