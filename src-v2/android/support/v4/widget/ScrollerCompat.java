...
public class ScrollerCompat {
    ...
    static {
        ...
        IMPL = n2 >= 14 ? new ScrollerCompatImplIcs() : (n2 >= 9 ? new ScrollerCompatImplGingerbread() : new ScrollerCompatImplBase());
    }
    ...
    public void fling(int n2, int n3, int n4, int n5, int n6, int n7, int n8, int n9) {
        IMPL.fling(this.mScroller, n2, n3, n4, n5, n6, n7, n8, n9);
    }

    public void fling(int n2, int n3, int n4, int n5, int n6, int n7, int n8, int n9, int n10, int n11) {
        IMPL.fling(this.mScroller, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11);
    }
    ...
    public void notifyHorizontalEdgeReached(int n2, int n3, int n4) {
        IMPL.notifyHorizontalEdgeReached(this.mScroller, n2, n3, n4);
    }

    public void notifyVerticalEdgeReached(int n2, int n3, int n4) {
        IMPL.notifyVerticalEdgeReached(this.mScroller, n2, n3, n4);
    }

    public void startScroll(int n2, int n3, int n4, int n5) {
        IMPL.startScroll(this.mScroller, n2, n3, n4, n5);
    }

    public void startScroll(int n2, int n3, int n4, int n5, int n6) {
        IMPL.startScroll(this.mScroller, n2, n3, n4, n5, n6);
    }
