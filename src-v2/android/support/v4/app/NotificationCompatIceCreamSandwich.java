...
class NotificationCompatIceCreamSandwich {
     ...
     */
    static Notification add(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int n2, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int n3, int n4, boolean bl2) {
        ...
        if ((notification.flags & 128) != 0) {
            bl3 = true;
            return context.setFullScreenIntent(pendingIntent2, bl3).setLargeIcon(bitmap).setNumber(n2).setProgress(n3, n4, bl2).getNotification();
        }
        bl3 = false;
        return context.setFullScreenIntent(pendingIntent2, bl3).setLargeIcon(bitmap).setNumber(n2).setProgress(n3, n4, bl2).getNotification();
    }
